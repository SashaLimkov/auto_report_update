...
class Employer(TimeBasedModel):
    ...
    # tg_urls: str = models.CharField("Здесь должна быть ссылка на тг", max_length=128, null=True, blank=True)
    tg_user: str = models.ForeignKey(TelegramUser, on_delete=models.SET_NULL, null=True, verbose_name="Ссылка на телеграм")
